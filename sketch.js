...
function draw() {
  ...
  rectMode(CENTER);
  ground.display("pink");
  box1.display("pink", "pink");
  box2.display("Magenta", "pink");
  box3.display("Magenta", "pink");
  box4.display("Magenta", "pink");
  box5.display("Magenta", "pink");
  box6.display("pink", "Magenta");
  box7.display("pink", "magenta");
  box8.display("pink", "magenta");
  box9.display("pink", "magenta");
  box10.display("cyan", "magenta");
  box11.display("cyan", "pink");
  box12.display("cyan", "pink");
  ...
  ball.display("darkblue", "lightPink");
